 $(document).ready(function() {
                    $.ajax({
                            type: "POST",
                            url: "http://192.168.1.76/ArchivosServidor/selectEjercicio.php",
                    ...
                    $.ajax({
                        type: "POST",
                        url: "http://192.168.1.76/ArchivosServidor/selectMusculo.php",
                        success: function(response)
                        {
                ...
                $.ajax({
                    type: "POST",
                    url: "http://192.168.1.76/ArchivosServidor/selectFuncion.php",
                    success: function(response)
                    {
