function flexiones(){
    ...
    $.ajax({
        type:"POST",
        url: "http://192.168.1.76/ArchivosServidor/actualizaFlexiones.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
...
function sentadillas(){
    ...
    $.ajax({
        type:"POST",
        url: "http://192.168.1.76/ArchivosServidor/actualizaSentadillas.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
...
function abdominales(){
    ...
    $.ajax({
        type:"POST",
        url: "http://192.168.1.76/ArchivosServidor/actualizaAbdominales.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
...
function fondos(){
    ...
    $.ajax({
        type:"POST",
        url: "http://192.168.1.76/ArchivosServidor/actualizaFondos.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
